    ...
    <div class="relative mx-4">
        ...
        <div class="max-h-44 overflow-y-scroll">
            <div class="flex items-center text-sm text-zinc-600 font-medium min-h-14 border-b">
                ...
                <span class="basis-3/12 grow pr-4">Developpement Web</span>
                <span class="basis-40 shrink-0 pr-4 pl-[1.5px]">Semestre 5</span>
                <span class="basis-2/12 grow pr-4  pl-[1.5px]">24/01/2024</span>
                <span class="basis-32 font-bold pr-4  pl-[1.5px]">4 heures</span>
                <span class="basis-[140px] flex pr-4 justify-center">
                        <div class="w-28 relative ">
                            <input type="number" name="" id="" value="5" class="border-[1.5px] border-zinc-200 w-full rounded-md outline-none focus:border-zinc-500 px-4 py-2 font-bold text-zinc-600">
