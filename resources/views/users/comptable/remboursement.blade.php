...
<div class="flex items-center text-sm text-zinc-400 font-nunito font-bold py-4 px-6">
    {{-- cols --}}
    <span class="w-3/12 pr-4">VACATAIRE</span>
    <span class="w-2/12 px-4">DUREE TOTALE</span>
    <span class="w-2/12 px-4">PROVENANCE</span>
    <span class="w-2/12 px-4">DISTANCE</span>
    <span class="w-[170px] text-center px-4">SITUATION</span>
    <span class="w-[140px] text-center">ACTION</span>
</div>


<div class="text-sm text-zinc-600 font-medium border border-zinc-200 rounded-md px-6 bg-white mb-4 relative">

    {{-- resume --}}
    <div class="py-4 flex items-center">
        {{-- cols --}}
        <span class="w-3/12 pr-4">Mouhamadou Mansour</span>
        <span class="w-2/12 px-4">20 Heures</span>
        <span class="w-2/12 px-4">Tambacounda</span>
        <span class="w-2/12 font-bold px-4">423 KM</span>
        ...
        <span class="w-[140px] relative flex items-center justify-center gap-4">
            <div class="icon-hover rounded-lg bg-zinc-100 font-semibold text-zinc-800">1</div>
            ...
            <button class="icon-hover">
                <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer">
                    <path d="M13.5 1.5L8.20711 6.79289C7.81658 7.18342 7.18342 7.18342 6.79289 6.79289L1.5 1.5" stroke="#71717a" stroke-width="2" stroke-linecap="round"/>
                </svg>
            </button>
        </span>
    </div>
...
<div class="text-sm text-zinc-600 font-medium border border-zinc-200 rounded-md px-6 bg-white mb-4 relative">
    ...
    {{-- resume --}}
    <div class="py-4 flex items-center mb-5 border-b border-b-zinc-200">
        {{-- cols --}}
        <span class="w-3/12 pr-4">Mouhamadou Mansour</span>
        <span class="w-2/12 px-4">20 Heures</span>
        <span class="w-2/12 px-4">Tambacounda</span>
        <span class="w-2/12 font-bold px-4">423.23 KM</span>
        <span class="w-[170px] flex px-4 justify-center">
            <span class="flex items-center bg-fuchsia-100 px-4 text-fuchsia-500 py-1 rounded font-semibold text-xs">Non</span>
        </span>
    ...
    <div class="relative mx-4">
        {{-- t-head --}}
        <div class="flex items-center bg-[#F1F4F9] w-full py-3 font-nunito font-bold text-zinc-800">
            {{-- cols --}}
            <span class="px-4">
            ...
            <span class="w-3/12 px-4">Matière</span>
            <span class="w-32">Semestre</span>
            <span class="w-2/12">Date</span>
            <span class="w-32">Durée</span>
            <span class="w-[140px] pl-4">Tickets</span>
            <span class="w-[160px] text-center">Statut</span>
            <span class="w-[215px] text-center">Action</span>
        </div>
        {{-- t-body --}}
        <div>
            <div class="w-full flex items-center border-b border-b-zinc-200 py-4">
                {{-- cols --}}
                <span class="px-4">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" id="checkbox" class="cursor-pointer">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12.4444 0.888889H3.55556C2.0828 0.888889 0.888889 2.0828 0.888889 3.55556V12.4444C0.888889 13.9172 2.0828 15.1111 3.55556 15.1111H12.4444C13.9172 15.1111 15.1111 13.9172 15.1111 12.4444V3.55556C15.1111 2.0828 13.9172 0.888889 12.4444 0.888889ZM3.55556 0C1.59188 0 0 1.59188 0 3.55556V12.4444C0 14.4081 1.59188 16 3.55556 16H12.4444C14.4081 16 16 14.4081 16 12.4444V3.55556C16 1.59188 14.4081 0 12.4444 0H3.55556Z" fill="#1C1C1C" fill-opacity="0.3"/>
                ...
                <span class="w-3/12 px-4">Developpement Web</span>
                <span class="w-32">Semestre 5</span>
                <span class="w-2/12">24/01/2024</span>
                <span class="w-32 font-bold">4 heures</span>
                <span class="w-[140px] flex pl-4">
                ...
                <span class="w-[160px] flex items-center justify-center">
                    <span class="bg-emerald-100 px-3 text-emerald-500 py-1 rounded font-semibold text-xs">Approuvé</span>
                </span>
                <span class="w-[215px] flex items-center justify-center gap-3 box-border">
            ...
            <div class="w-full flex items-center border-b border-b-zinc-200 py-4">
                ...
                <span class="w-[215px] flex items-center justify-center gap-3 box-border">
                    <form action="" class="m-0">
                        <button class="font-medium btn-2 bg-zinc-300 text-zinc-800 text-xs">Rembourser</button>
                    </form>
                    {{-- separator --}}
                    <div class=" w-0.5 h-5 bg-zinc-200"></div>
                    <form action="" method="" class="m-0">
                        <button class="">
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13 7C13 10.3137 10.3137 13 7 13C3.68629 13 1 10.3137 1 7C1 3.68629 3.68629 1 7 1C8.53671 1 9.93849 1.57771 11 2.52779M11.6667 1V3C11.6667 3.36819 11.3682 3.66667 11 3.66667H9" stroke="#E4E4E7" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                        </button>
                    </form>
                </span>
        ...
        {{-- t-foot --}}
        <div class="h-20 text-sm font-semibold flex items-center justify-between mt-4">
