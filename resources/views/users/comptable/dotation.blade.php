...
<section class="px-6 min-h-screen overflow-hidden">
    ...
    <div class="border-b-zinc-200 border-b-2 mb-8 text-zinc-500">
        ...
        <a href="{{ route('dotation.historique') }}" class="py-3 px-6 inline-block relative @if(in_array(Route::currentRouteName(), ['dotation.historique', 'filtre.historique', 'filtre.historique.month'])) cr text-zinc-600 font-medium @endif">Historique</a>
    </div>
