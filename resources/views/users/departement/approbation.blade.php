...
<div class="">
    ...
    <div class="flex items-center text-sm font-medium border border-zinc-200 h-[70px] py-2 rounded-md bg-white mb-4">
        ...
        <span class="basis-[150px] pr-4">{{$sceance_cour->date}}</span>
        <span class="basis-[170px] relative flex items-center justify-center gap-4 mr-4">
            ...
            <form action="" method="" class="m-0">
                <button class="icon-hover cursor-pointer">
    ...
    <div class="flex items-center text-sm font-medium border border-zinc-200 h-[70px] py-2 rounded-md bg-white mb-4">
        ...
        <span class="basis-[23%] grow pr-4">Mouhamadou Mansour</span>
        <span class="basis-[22%] grow pr-4">Programmation Orientée Objet</span>
        <span class="basis-[17%] grow pr-4">Informatique</span>
        <span class="basis-[130px] font-bold pr-4">4 Heures</span>
        <span class="basis-[150px] pr-4">18/02/2024</span>
        <span class="basis-[170px] relative flex items-center justify-center gap-4 mr-4">
            <form action="" method="" class="m-0">
            ...
            <div class=" w-0.5 h-6 bg-zinc-200"></div>
            <form action="" method="" class="m-0">
                <button class="icon-hover" disabled>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
