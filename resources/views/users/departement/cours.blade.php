...
<section class="px-6 min-h-screen ">
    ...
    <div class="border-b-zinc-200 border-b-2 mb-10 text-zinc-500">
        <a href="{{ route('cours.all') }}" class="relative py-3 px-6 inline-block  @if(in_array(Route::currentRouteName(), ['cours.all', 'cours.all.filtre', 'cours.all.filtre.month', 'shearch.cours'])) cr text-zinc-700 font-medium @endif">Tous les cours</a>
...
<div class="bg-white border border-zinc-200 rounded-lg px-8 py-6 w-8/12 scale-75 opacity-0 trans-2 font-mtrph">
    ...
    <form action="{{{route('cours.store')}}}" method="post" class="m-0 mt-6" id="subscription">
        ...
        <div class="mb-10 ">
            ...
            <div class="w-full flex gap-4 mb-2">
                <div class="w-full flex flex-col relative">
                    ...
                    <div class="w-full relative ">
                        <input type="number" name="duree" id="duree" value="2" class="input-2 w-full">
                        {{-- erreur gerée en js --}}
                        <div class="text-sm text-red-600 font-medium mt-2">
                        </div>
            ...
            <div class="w-full flex flex-col mb-2">
                <label></label>
                <textarea name="remarque" id="remarque" rows="4" placeholder="Remarque .... " class="input-2 w-full"></textarea>
                {{-- erreur gerée en js --}}
                <div class="text-sm text-red-600 font-medium mt-2">
                </div>
            </div>
