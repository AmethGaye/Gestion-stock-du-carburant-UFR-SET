...
<div class="">
    ...
    <div class="text-sm h-20 overflow-hidden font-medium border border-zinc-200 rounded-md px-4 bg-white mb-4 relative transition-[height] duration-150" id="super-contain">
        ...
        <div class="min-h-20 flex items-center border-b border-zinc-200 mb-4">
            ...
            <span class="basis-[23%] grow pr-4">Mouhamadou Mansour Diouf</span>
            <span class="basis-[22%] grow pr-4">Mansour@gmail.com</span>
            <span class="basis-[160px] font-bold pr-4">14 Heures</span>
            <span class="basis-[160px] pr-4">Diourbel</span>
        ...
        <div class="mx-4">
            ...
            <div class="max-h-44 overflow-y-scroll">
                ...
                <div class="flex items-center text-sm py-3 border-b min-h-14">
                    ...
                    <span class="basis-[23%] grow pr-4">Développement Web</span>
                    <span class="basis-[15%] grow pr-4">Semestre 4</span>
                    <span class="basis-[22%] grow pr-4">Informatique</span>
                    <span class="basis-[14%] grow pr-4">18/01/2024</span>
                    <span class="basis-[150px] font-semibold pr-4">3 Heure</span>
