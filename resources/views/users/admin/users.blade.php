...
<div class="bg-white border border-zinc-200 rounded-lg px-8 py-6 w-8/12 scale-75 opacity-0 trans-2 font-mtrph">
    ...
    <form action="{{route('add.user')}}" method="post" class="m-0 mt-6">
        @csrf
        ...
        <div class="mb-10 ">
            ...
            <div class="w-full flex gap-4">
                ...
                <div class="w-full  flex flex-col mb-4">
                    <label for="ufr" class="font-medium text-zinc-700">Filière</label>
                    <select name="filiere" id="ufr" class="input-2">
