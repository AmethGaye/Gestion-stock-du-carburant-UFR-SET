        ...
        <div class="px-4 py-3 bg-white rounded-lg shadow_2 flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-2 text-sm">
                ...
                <div class="bg-zinc-100 text-zinc-600 border relative min-w-[118px] h-[34px] rounded-md text-sm">
                    ...
                    <div class="absolute -left-32 top-11 min- w-[360px] rounded-lg bg-white z-40 border tracking-wide hidden p-4" id="filters-container">
                        ...
                        <div class="flex flex-wrap gap-2 pb-4 border-b mt-4">
                            @foreach($ufr as $item)
                                <div class="py-1.5 px-5 hover:bg-zinc-100 cursor-pointer rounded-xl" onclick="addFilter(this, 'ufr_id', {{ $item->id }})">{{ $item->nom }}</div>
                            @endforeach
                            <div class="py-1.5 px-5 hover:bg-zinc-100 cursor-pointer rounded-xl" onclick="addFilter(this, 'status', '1')">Active</div>
                            <div class="py-1.5 px-5 hover:bg-zinc-100 cursor-pointer rounded-xl" onclick="addFilter(this, 'status', '0')">Inactive</div>
                            <div class="py-1.5 px-5 hover:bg-zinc-100 cursor-pointer rounded-xl" onclick="addFilter(this, 'role', 'admin')">Admin</div>
                            <div class="py-1.5 px-5 hover:bg-zinc-100 cursor-pointer rounded-xl" onclick="addFilter(this, 'role', 'directeur')">Directeur</div>
                            <div class="py-1.5 px-5 hover:bg-zinc-100 cursor-pointer rounded-xl" onclick="addFilter(this, 'role', 'chef_departement')">Chef departement</div>
                            <div class="py-1.5 px-5 hover:bg-zinc-100 cursor-pointer rounded-xl" onclick="addFilter(this, 'role', 'assistant')">Assistant</div>
                ...
                <button  type="menu" class="btn-1 bg-zinc-800 text-white border border-zinc-800" id="new-user" onclick="displayContainer(`/admin/users`)">
                    <svg width="10" height="10" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="">
        ...
        <div class="">
            ...
            <div class="w-full flex gap-4">
                <div class="w-full flex flex-col relative mb-3" id="default-mdp">
                    ...
                    <span class="absolute right-4 top-[44px] hidden cursor-pointer" id="eyes" onclick="hidePassword(0)">
                    ...
                    <span class="absolute right-4 top-[44px] cursor-pointer" id="eyes-hidden" onclick="showPassword(0)">
                        <svg width="16" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
