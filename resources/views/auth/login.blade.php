    ...
    <div class="w-full h-full relative flex justify-center items-center bg-white text-zinc-800 font-mtrph">
        <div class="w-4/12 relative">
            <div class="w-full  flex items-center flex-col">
                ...
                <p class="text-base text-zinc-400">Merci d'entrer vos informations de connexion</p>
            </div>
            ...
            <form action="{{route('auth.login')}}" method="post" class="mt-10">
                ...
                <div class="mb-6">
                    ...
                    <div class="w-full flex flex-col relative">
                        ...
                        <input type="password" name="password" id="password" class="input-2">
                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute right-4 top-[44px] hidden cursor-pointer">
                        ...
                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute right-4 top-[44px] cursor-pointer">
