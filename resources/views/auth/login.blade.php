            ...
            <form action="{{route('auth.login')}}" method="post" class="mt-10">
                ...
                <div class="mb-6">
                    ...
                    <div class="w-full flex flex-col relative">
                        ...
                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute right-4 top-[42px] hidden cursor-pointer">
                        ...
                        @error('password')
                            <span class="text-red-500">{{ $message}}</span>
                        @enderror
                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute right-4 top-[42px] cursor-pointer">
